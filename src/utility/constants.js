...
export const EMAIL_HEADER =
  ...
  '<div class="u-row" style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #556cd6;">' +
  ...
  '<h2 class="v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: \'Open Sans\',sans-serif; font-size: 20px;">Turni telefono - 25/01/2023</h2>' +
  "</td>" +
  "</tr>" +
  "</tbody>" +
  "</table>" +
  ...
  "<tbody>" +
  "<tr>" +
  '<td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 50px;font-family:\'Rubik\',sans-serif;" align="left">' +
